package com.moyou.moyouRms.dao.statistics;
...
public interface UserFundRegulationDao {
	/**
	 ...
	 * @return
	 */
	int updateUserFundRegulation(@Param("enti") UserFundRegulation value,
	 ...
	 * @return
	 */
	int updateNonEmptyUserFundRegulation(@Param("enti") UserFundRegulation value,
			@Param("assist") Assist assist);
