...
public interface LiveUserLevelSetDao{
	/**
	 ...
	 * @return
	 */
    int updateLiveUserLevelSet(@Param("enti") LiveUserLevelSet value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyLiveUserLevelSet(@Param("enti") LiveUserLevelSet value, @Param("assist") Assist assist);
}