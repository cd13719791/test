...
public interface LiveUserConvertService {
	/**
	 ...
	 * @return
	 */
	int updateLiveUserConvert(LiveUserConvert value, Assist assist);
	 ...
	 * @return
	 */
	int updateNonEmptyLiveUserConvert(LiveUserConvert value, Assist assist);
