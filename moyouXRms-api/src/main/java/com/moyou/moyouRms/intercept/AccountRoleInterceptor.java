...
public class AccountRoleInterceptor implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request,
		 ...
		 * 更新操作时间
		 */
		sysSessionManagerService.updateSessionSetTime(AccountShiroUtil
		...
		if (resourcesService.validata(accountId, handlerMethod.getMethod()
		...
		// logger.error("[ " + accountId + " ]权限不符" + "param{" +
		// handlerMethod.getMethod().toString() + "}");
