/**
 */
package com.moyou.moyouRms.util.mac;
...
public class GetMacAddress {
	...
	public static void main(String[] args) {
		System.out.println(GetMacAddress.getMacAddress("220.181.111.148"));
		System.out.println(GetMacAddress.getMacAddress("175.152.116.69"));
	}
