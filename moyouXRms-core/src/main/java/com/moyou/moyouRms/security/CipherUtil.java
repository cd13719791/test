...
public class CipherUtil {
	...
	public static String generateKey() {
		...
		return Base64.encodeToString(aesCipherService.generateNewKey()
				.getEncoded());
	}
	 ...
	 * @return
	 */
	public static String createPwdEncrypt(String username, String password,
			String salt) {
